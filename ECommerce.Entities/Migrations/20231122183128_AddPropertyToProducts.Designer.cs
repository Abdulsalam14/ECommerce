...
namespace ECommerce.Entities.Migrations
{
    ...
    [Migration("20231122183128_AddPropertyToProducts")]
    partial class AddPropertyToProducts
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerce.Entities.Models.AlphabeticalListOfProduct", b =>
                {
            ...
            modelBuilder.Entity("ECommerce.Entities.Models.CategorySalesFor1997", b =>
                {
                    b.Property<string>("CategoryName")
                        .IsRequired()
                        .HasMaxLength(15)
            ...
            modelBuilder.Entity("ECommerce.Entities.Models.CurrentProductList", b =>
                {
                    b.Property<int>("ProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ECommerce.Entities.Models.Customer", b =>
                {
                    b.Property<string>("CustomerId")
                        .HasMaxLength(5)
                        .HasColumnType("nchar(5)")
            ...
            modelBuilder.Entity("ECommerce.Entities.Models.CustomerAndSuppliersByCity", b =>
                {
                    b.Property<string>("City")
                        .HasMaxLength(15)
                        .HasColumnType("nvarchar(15)");
            ...
            modelBuilder.Entity("ECommerce.Entities.Models.CustomerDemographic", b =>
                {
                    b.Property<string>("CustomerTypeId")
                        .HasMaxLength(10)
                        .HasColumnType("nchar(10)")
            ...
            modelBuilder.Entity("ECommerce.Entities.Models.Employee", b =>
                {
            ...
            modelBuilder.Entity("ECommerce.Entities.Models.Invoice", b =>
                {
                    b.Property<string>("Address")
                        .HasMaxLength(60)
                        .HasColumnType("nvarchar(60)");
            ...
            modelBuilder.Entity("ECommerce.Entities.Models.OrderDetail", b =>
                {
                    b.Property<int>("OrderId")
                        .HasColumnType("int")
                        .HasColumnName("OrderID");
            ...
            modelBuilder.Entity("ECommerce.Entities.Models.OrderDetailsExtended", b =>
                {
                    b.Property<float>("Discount")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("ECommerce.Entities.Models.OrdersQry", b =>
                {
                    b.Property<string>("Address")
                        .HasMaxLength(60)
                        .HasColumnType("nvarchar(60)");
            ...
            modelBuilder.Entity("ECommerce.Entities.Models.OrderSubtotal", b =>
                {
                    b.Property<int>("OrderId")
                        .HasColumnType("int")
                        .HasColumnName("OrderID");
            ...
            modelBuilder.Entity("ECommerce.Entities.Models.ProductsAboveAveragePrice", b =>
                {
                    b.Property<string>("ProductName")
                        .IsRequired()
                        .HasMaxLength(40)
            ...
            modelBuilder.Entity("ECommerce.Entities.Models.ProductSalesFor1997", b =>
                {
                    b.Property<string>("CategoryName")
                        .IsRequired()
                        .HasMaxLength(15)
            ...
            modelBuilder.Entity("ECommerce.Entities.Models.ProductsByCategory", b =>
                {
                    b.Property<string>("CategoryName")
                        .IsRequired()
                        .HasMaxLength(15)
            ...
            modelBuilder.Entity("ECommerce.Entities.Models.QuarterlyOrder", b =>
                {
                    b.Property<string>("City")
                        .HasMaxLength(15)
                        .HasColumnType("nvarchar(15)");
            ...
            modelBuilder.Entity("ECommerce.Entities.Models.Region", b =>
                {
            ...
            modelBuilder.Entity("ECommerce.Entities.Models.SalesByCategory", b =>
                {
                    b.Property<int>("CategoryId")
                        .HasColumnType("int")
                        .HasColumnName("CategoryID");
            ...
            modelBuilder.Entity("ECommerce.Entities.Models.SalesTotalsByAmount", b =>
                {
                    b.Property<string>("CompanyName")
                        .IsRequired()
                        .HasMaxLength(40)
            ...
            modelBuilder.Entity("ECommerce.Entities.Models.Shipper", b =>
                {
            ...
            modelBuilder.Entity("ECommerce.Entities.Models.SummaryOfSalesByQuarter", b =>
                {
                    b.Property<int>("OrderId")
                        .HasColumnType("int")
                        .HasColumnName("OrderID");
            ...
            modelBuilder.Entity("ECommerce.Entities.Models.SummaryOfSalesByYear", b =>
                {
                    b.Property<int>("OrderId")
                        .HasColumnType("int")
                        .HasColumnName("OrderID");
            ...
            modelBuilder.Entity("ECommerce.Entities.Models.Supplier", b =>
                {
                    b.Property<int>("SupplierId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ECommerce.Entities.Models.Territory", b =>
                {
            ...
            modelBuilder.Entity("CustomerCustomerDemo", b =>
                {
                    b.HasOne("ECommerce.Entities.Models.Customer", null)
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .IsRequired()
                        .HasConstraintName("FK_CustomerCustomerDemo_Customers");

                    b.HasOne("ECommerce.Entities.Models.CustomerDemographic", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ECommerce.Entities.Models.Employee", b =>
                {
                    b.HasOne("ECommerce.Entities.Models.Employee", "ReportsToNavigation")
            ...
            modelBuilder.Entity("ECommerce.Entities.Models.Order", b =>
                {
                    b.HasOne("ECommerce.Entities.Models.Customer", "Customer")
                        .WithMany("Orders")
                        .HasForeignKey("CustomerId")
                        .HasConstraintName("FK_Orders_Customers");

                    b.HasOne("ECommerce.Entities.Models.Employee", "Employee")
                        .WithMany("Orders")
                        .HasForeignKey("EmployeeId")
                        .HasConstraintName("FK_Orders_Employees");

                    b.HasOne("ECommerce.Entities.Models.Shipper", "ShipViaNavigation")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("ECommerce.Entities.Models.Product", b =>
                {
                    ...
                    b.HasOne("ECommerce.Entities.Models.Supplier", "Supplier")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("ECommerce.Entities.Models.Territory", b =>
                {
                    b.HasOne("ECommerce.Entities.Models.Region", "Region")
            ...
            modelBuilder.Entity("EmployeeTerritory", b =>
                {
                    b.HasOne("ECommerce.Entities.Models.Employee", null)
                        .WithMany()
                        .HasForeignKey("EmployeeId")
                        .IsRequired()
                        .HasConstraintName("FK_EmployeeTerritories_Employees");

                    b.HasOne("ECommerce.Entities.Models.Territory", null)
                        .WithMany()
